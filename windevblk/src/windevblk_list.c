...
UINT GetDevBlkCount(PUINT pRawDevCount)
{
    UINT uiCount = 0;
    UINT uiRawDevCount = 0;
...
UINT GetRawDevCount(VOID)
{
    UINT uiCount = 0;

    for (UINT iDevBlkNumber = 0; iDevBlkNumber < 128; iDevBlkNumber++)
    {
...
//        if (g_devblk_array[iDevBlkNumber])
//        {
//            uiCount += g_devblk_array[iDevBlkNumber]->DriveInfo.LayoutInfo.PartitionCount;
//        }
//    }
//
//    return uiCount;
